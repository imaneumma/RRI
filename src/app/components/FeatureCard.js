...
const FeatureCard = ({ feature }) => {
  return (
    <div className="flex flex-col items-center text-center p-4 cursor-pointer  text-gray-700 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-orange-100 duration-300">
