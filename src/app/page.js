  ...
  return (
    ...
    <div className="p-8  ">
      <div className="grid grid-cols-2  gap-4 my-12 min-h-[496px]">
        <h1 className="text-6xl tracking-wide font-light font-sans uppercase mt-16 max-w-64 animate-in slide-in-from-left duration-700 hover:slide-in-from-right">
